...
io.sockets.on('connection', function(socket) {
    ...
    socket.on('username', function(username) {
        ...
        io.emit('is_online', '<span id="joined"></span> <i><strong>' + socket.username + '</strong> joined the chat..</i>'); // 🔵
    });

    socket.on('disconnect', function(username) {
        io.emit('is_online', '<span id="left"></span> <i><strong>' + socket.username + '</strong> left the chat..</i>'); // 🔴
    })
